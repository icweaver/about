...
\cventry
    {JuliaAstro \href{https://juliaastro.github.io/dev/index.html}{[link]}} % Organization
    {Contributor and member of the Julia astronomy organization} % Job title
    {2020 - Present} % Date(s)
...
\cventry
    {Team member, Graduate course final project \href{https://github.com/icweaver/pyhat}{[link]}} % Organization
    {Python implementation for new algorithm estimating MCMC uncertainty} % Job title
    {Fall 2019} % Date(s)
    {San Francisco, CA} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
\cventry
    {Team member, Graduate course final project \href{https://spacejam.readthedocs.io/en/latest/}{[link]}} % Organization
    {Python package for differential equation solving, powered by automatic differentiation} % Job title
    {Fall 2018} % Date(s)
    {San Francisco, CA} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
